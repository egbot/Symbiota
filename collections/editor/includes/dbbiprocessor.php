<script>
 $(function() {
	 ...
	 autoOpen: false,
	 position: { my: "center center", at: "left bottom", of: "#zoomInfoDiv" },
	 maxWidth: 700,
         maxHeight: 700,
         width: 600,
         height: 610,
...
<div style="width:100%;height:915px;">
	<fieldset style="height:64.2%;background-color:white;">
		<legend><b>Selection Area</b></legend>
		<div style="margin-top:-10px;height:15px;position:relative">
			<div style="float:left;padding-top:3px"><a id="zoomInfoDiv" href="#">How to select zoom area</a></div>
			<div id="zoomInfoDialog">
                <img src="../../../images/selection_area.gif"></img>
                <p>Use left-click on mouse, or trackpad, and move for selection. </p>
		<p>Reset the selection area with a left-click. </p>
			</div>
